...
namespace CompositeImages
{
    public partial class Form1 : Form
    {
        ...
        ToolStripButton toolStripButton1 = new ToolStripButton() {Name="Load", Text="Load" };
        ToolStripButton toolStripButton2 = new ToolStripButton() {Name="Unload", Text="Unload" };
        ...
        public Form1()
        {
            ...
            toolStrip.Size = new Size(200, 100);
        ...
        Bitmap CreateCompositeBitmap(IEnumerable<Bitmap> bitmaps)
        {
            ...
            Bitmap result = new Bitmap(largest.Width, largest.Height, PixelFormat.Format32bppArgb);

            // Lock the result Bitmap.
            var resultBitmapData = result.LockBits(new Rectangle(new Point(), result.Size), ImageLockMode.WriteOnly, result.PixelFormat);
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            // if it exists.
            string initialDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonPictures), "Sample Pictures");
